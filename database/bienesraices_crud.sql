...
START TRANSACTION;
USE `bienesraices_crud`;
INSERT INTO `bienesraices_crud`.`vendedores` (`id`, `nombre`, `apellido`, `telefono`) VALUES (1, 'Javier', 'Mendieta', '2461038675');
INSERT INTO `bienesraices_crud`.`vendedores` (`id`, `nombre`, `apellido`, `telefono`) VALUES (2, 'Karen', 'Perez', '2461038642');
